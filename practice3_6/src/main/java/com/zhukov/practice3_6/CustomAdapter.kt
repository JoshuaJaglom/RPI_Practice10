...
class CustomAdapter (private val colorNames: Array<String>, private val colorsValues: IntArray,
                     private var viewModel: MainViewModel): RecyclerView.Adapter<CustomAdapter.MyViewHolder>() {
